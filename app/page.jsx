...
const Home = () => {
    return (
        <section className='w-full flex-center flex-col'>
            <h1 className='head_text text-center'>Share and Discover<br className='mx-md:hidden' /><span className='blue_gradient text-center'>Inspiring Quotes on Quotify</span></h1>
